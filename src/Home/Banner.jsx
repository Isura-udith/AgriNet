import BannerImg from "../assets/website/shoping.png";
        ...
        <div className="grid items-center grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            <h1 data-aos="fade-up" className="text-3xl font-bold sm:text-4xl">
              Weekly Sale upto 50% Off
            </h1>
            <p
              data-aos="fade-up"
              className="text-sm leading-5 tracking-wide text-gray-500"
            >
              &quot;Great thoughts come together to create something new and exciting. Every choice shows purpose and determination, leading to amazing results.&quot;
            </p>
